...
?> 
<title> Book Car | ASTU Car Rental </title>
<head>
...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Welcome! </br></br>Rent here </h2><br>
        ...
        ?>
            ...
            <h5> Model Number:&nbsp; <?php echo($car_nameplate);?></h5>
