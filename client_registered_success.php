<html>
  ...
  <head>
    <title> Client Signup | ASTU Car Rental </title>
...
$query = "INSERT into clients(client_name,client_username,client_phone,client_address,client_password) VALUES('" . $client_name . "','" . $client_username . "','" . $client_phone . "','" . $client_address ."','" . $client_password ."')";
